...
class RewardModelWorker(MegatronWorker, DistProfilerExtension):
    ...
    def init_model(self):
        ...
        input_tokenizer_local_path = copy_to_local(self.config.model.input_tokenizer, use_shm=use_shm)
        input_tokenizer = hf_tokenizer(input_tokenizer_local_path)
    ...
    # TODO: reward model should use its own tokenizer instead of the input tokenizer
